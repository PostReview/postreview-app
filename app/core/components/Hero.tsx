...
export const Hero = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center pt-24 pb-12 px-4 w-full bg-gray-light dark:bg-gray-darkest">
        ...
        <div id="action-container" className="text-xl text-green rounded-lg bg-gray-medium dark:bg-gray-medium hover:bg-gray-dark">
