...
export const Hero = () => {
  return (
    <div className="flex flex-col justify-evenly items-center bg-purple-300 py-14  w-screen">
      <div className="text-3xl md:text-5xl lg:text-7xl">Post your review, post-publication.</div>
