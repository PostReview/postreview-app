  ...
  return (
    <div id="how-it-works-container" className="flex flex-col min-h-screen p-8 max-w-4xl">
      ...
      <div id="steps-container" className="flex flex-col items-center">
        ...
        <div>
          <div className="mb-1 ml-3 md:ml-24 text-3xl font-bold text-gray-darkest dark:text-white">
            2. Review
          </div>
          <div className="mb-3 mx-3 md:ml-24 text-xl text-gray-darkest dark:text-white">
        ...
        <div>
          <div className="ml-3 mb-1 md:ml-32 text-3xl font-bold text-gray-darkest dark:text-white">
            3. Submit
          </div>
          <div className="mx-3  md:ml-32 text-xl text-gray-darkest dark:text-white">
